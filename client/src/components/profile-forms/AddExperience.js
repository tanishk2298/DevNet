    ...
    <div className="container mt-2">
        <form className="profile" onSubmit={e => {
          ...
          addExperience(formData, history);
            ...
            <i className="fas fa-briefcase text-primary"></i>&nbsp;Add your experience
            </h2>
            <p className="text-left text-muted">
              ...
              <div className="form-group">
                <input className="form-control" type="text" placeholder="* Job Title" name="title" value={title} onChange={e => onChange(e)} required />
              </div>
              <div className="form-group">
                <input className="form-control" type="text" placeholder="* Company" name="company" value={company} onChange={e => onChange(e)} required />
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                <textarea className="form-control" name="description" cols="30" rows="3" placeholder="Job Description" value={description} onChange={e => onChange(e)} ></textarea>
              </div>
